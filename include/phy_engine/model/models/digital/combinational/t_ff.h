...
namespace phy_engine::model
{
    ...
    inline bool set_attribute_define(model_reserve_type_t<TFF>, TFF& clip, ::std::size_t index, variant value) noexcept
    {
    ...
    inline variant get_attribute_define(model_reserve_type_t<TFF>, TFF const& clip, ::std::size_t index) noexcept
    {
        switch(index)
        {
    ...
    inline constexpr ::fast_io::u8string_view get_attribute_name_define(model_reserve_type_t<TFF>, ::std::size_t index) noexcept
    {
        switch(index)
        {
            case 0: return u8"Ll";
